...
public class Builder {
    ...
    public static class BuilderBuilder {
        ...
        public String toString() {
            return "ru.java_.patterns.pattern.creational.builder.Builder.BuilderBuilder(field1=" + this.field1 + ", field2=" + this.field2 + ", field3=" + this.field3 + ", field4=" + this.field4 + ", field5=" + this.field5 + ")";
        }
    }
}
