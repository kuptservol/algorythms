...
public class Tree<T> {
    ...
    public String toString() {
        return "ru.skuptsov.puzzlers.job.interview.programcreek.tree.traversal.Tree(root=" + this.getRoot() + ")";
    }
    ...
    public static class TreeBuilder<T> {
        ...
        public String toString() {
            return "ru.skuptsov.puzzlers.job.interview.programcreek.tree.traversal.Tree.TreeBuilder(root=" + this.root + ")";
        }
    }
}
