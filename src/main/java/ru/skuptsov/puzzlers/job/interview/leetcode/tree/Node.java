...
public class Node<T> {
    ...
    public String toString() {
        return "ru.skuptsov.puzzlers.job.interview.programcreek.tree.traversal.Node(value=" + this.getValue() + ", left=" + this.getLeft() + ", right=" + this.getRight() + ")";
    }
    ...
    public static class NodeBuilder<T> {
        ...
        public String toString() {
            return "ru.skuptsov.puzzlers.job.interview.programcreek.tree.traversal.Node.NodeBuilder(value=" + this.value + ", left=" + this.left + ", right=" + this.right + ")";
        }
    }
}
