...
public class CockTailIngredients {
    ...
    private static class IngredientProps {
        ...
        public static class IngredientPropsBuilder {
            ...
            public String toString() {
                return "ru.skuptsov.puzzlers.adventofcode.CockTailIngredients.IngredientProps.IngredientPropsBuilder(capacity=" + this.capacity + ", durability=" + this.durability + ", flavor=" + this.flavor + ", texture=" + this.texture + ", calories=" + this.calories + ")";
            }
        }
    }
